...
const setActiveLink = ({ isActive }) =>
	isActive
		? 'styled-navlink position-relative text-decoration-none styled-navlink-active'
		: 'styled-navlink position-relative text-decoration-none styled-navlink-inactive';
				...
				<Row>
					<Col>
						<NavbarBrand href="/" className="d-flex">
							<img
								src="/assets/images/utb/utb-logo-1.webp"
								alt="УТБ Ресурс"
								width="45%"
							/>
						</NavbarBrand>
					...
					<Col>
						<NavbarBrand href="/" className="d-flex">
							<img
								src="/assets/images/utb/utb-logo-2.webp"
								className="ms-auto"
								alt="Медичні технології заради життя"
								width="45%"
							/>
						</NavbarBrand>
					</Col>
					...
					<Col className="ps-4" xs="7" sm="5" md="3">
						...
						>
							<DropdownToggle
								...
								style={{ borderRadius: isOpenMenu ? '5px 5px 0 0' : '5px' }}
							>
								Каталог
							</DropdownToggle>
							<DropdownMenu>
								{categories.map((category, index) =>
									'secondaryCategory' in category ? (
										<Accordion
											...
											body={category.secondaryCategory.map(
												(secondary, index) => (
													<Link
